...
public class SoundManager : MonoBehaviour
{
    ...
    public AudioClip step1, step2, radianceSource, dash, sword1, sword2, enemyHit1, enemyHit2, teleport, blobDeath, bowDraw, bowRelease, batAgro, blobAgro, deerLaunch, deerDeath, eSwipe, playerHit1, playerHit2, lightSwitch, deerAgro, turtleAgro, turtleDeath, batDeath;
